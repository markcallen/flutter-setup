...
- `.gemini/rules/publishing-api.md` — REST API publishing specialist - Docker or platform service CD with runtime health checks
...
- `.gemini/rules/publishing-web.md` — Web app publishing specialist - Docker or platform app CD on push to main
- `.gemini/rules/git-hooks.md` — Rules for git-hooks
